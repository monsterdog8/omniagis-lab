...
def mse_score(
    ...
    Args:
        predictions: dict of sample_id -> predicted value.
        truth: dict of sample_id -> true value.
        missing_penalty: added per missing prediction.
        invalid_penalty: added per non-finite prediction.
        range_penalty: added per out-of-[0,1] prediction.
...
def compare_prediction_lock(
    ...
    Expected prediction_lock structure::
    ...
    Required observation fields::
        ...
        run_id, phase, <primary_metric>, ledger_replay_status,
        control_effects, production_unlocked, stdout_retained, stderr_retained
    """
