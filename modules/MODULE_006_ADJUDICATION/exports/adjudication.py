...
def score_adjudication(
    ...
    Args:
        rows: list of dicts with at least pred_field and human_field.
        labels: ordered list of label classes.
        pred_field: column name for classifier predictions.
        human_field: column name for human ground truth.

    Returns dict with per-label metrics, confusion matrix summary, and completion rate.
    """
    total = len(rows)
